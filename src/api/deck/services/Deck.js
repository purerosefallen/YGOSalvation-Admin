...
module.exports = {
  ...
  fetchAll: (params, populate) => {
    ...
    const populateOpt = populate || Deck.associations
  ...
  edit: async (params, values) => {
    ...
    const entry = await Deck.updateOne(params, data, { multi: true });
  ...
  search: async (params) => {
    ...
    const $or = Object.keys(Deck.attributes).reduce((acc, curr) => {
      switch (Deck.attributes[curr].type) {
        case 'integer':
        case 'float':
        case 'decimal':
